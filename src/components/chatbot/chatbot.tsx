...
const QUICK_QUESTIONS = [
  ...
  "What skills are in demand in my region?",
...
export function Chatbot({ className }: ChatbotProps) {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      text: "Hello! I'm your BharatLink assistant. I can help you navigate the platform, set up your profile, find opportunities, and showcase your skills effectively. How can I help you today?",
      isUser: false,
      timestamp: new Date()
    }
  ]);
        ...
        <Card className="w-80 h-96 flex flex-col shadow-xl border-0 bg-white">
          ...
          <div className="flex items-center justify-between p-4 border-b bg-red-600 text-white rounded-t-lg">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold">BharatLink Assistant</span>
            </div>
            <Button
              variant="ghost"
              size="icon"
